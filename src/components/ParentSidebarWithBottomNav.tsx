...
interface ParentSidebarWithBottomNavProps {
  isMobileMenuOpen: boolean;
  setIsMobileMenuOpen: (open: boolean) => void;
}

const ParentSidebarWithBottomNav: React.FC<ParentSidebarWithBottomNavProps> = () => {
...
export default ParentSidebarWithBottomNav;
